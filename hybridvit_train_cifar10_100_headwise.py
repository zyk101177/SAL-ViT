...
def init_parser(parser):
    ...
    parser.add_argument('--batch_size', default=512, type=int) # 512
...
def train_top_module(args):
    ...
    if random_sa_selection == False and fix_sa_selection == None:
        ...
        for epoch in range(NASepochs):
            ...
            # if cur_self_attn_count < lowest_self_attn_count:
            #     lowest_self_attn_count = cur_self_attn_count
            
            # elif cur_self_attn_count >= lowest_self_attn_count:
            #     lam = args.kappa*lam
    ...
    for epoch in range(finetune_epoch):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model, f"./best_model/headwise_vit_approx_{args.softmax_approx}_dataset_{args.dataset}_attention_{args.attention_mechanism}_self_attn_limit_{args.self_attn_limit}_randomSAselect_{random_sa_selection}_fixSALocation_{fix_sa_selection}_NASepoch_{args.NAS_epoch}_numHead_{args.num_heads}.pth")
